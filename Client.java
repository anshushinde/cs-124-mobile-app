...
public final class Client {
  ...
  public void getRating(
      @NotNull Summary summary, @NonNull Consumer<ResultMightThrow<Rating>> callback) {
  ...
  public void postRating(
      @NotNull Rating rating, @NonNull Consumer<ResultMightThrow<Rating>> callback) {

    String jsonRating;
    try {
      jsonRating = OBJECT_MAPPER.writeValueAsString(rating);
    } catch (JsonProcessingException e) {
        ...
        new StringRequest(
            ...
            response -> {
              try {
                ...
                Rating r = OBJECT_MAPPER.readValue(response, Rating.class);
                callback.accept(new ResultMightThrow<>(r));
              } catch (JsonProcessingException e) {
                callback.accept(new ResultMightThrow<>(e));
              }
            },
          ...
          public byte[] getBody() {
            try {
              return jsonRating.getBytes("utf-8");
